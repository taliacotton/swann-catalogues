...
TYPESET: <p>The first is a cover for <em>The New Yorker</em>, published October 11,
  ...
  the lot.</p><p>Published Images:</p><p><img src="https://res.cloudinary.com/dcryyrd42/image/upload/v1622813153/260-ii_p4xjlv.png"></p><p>Testing
  text below. Hinged to double-sided window matte. Printed tear sheets of the published
  covers accompany the lot.</p>
