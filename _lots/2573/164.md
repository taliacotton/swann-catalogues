...
TYPESET: "sending photographic proofs of two drawings and \"Taverne Vénitienne\" [not present], inquiring whether to reproduce them, stating that negatives are available from the photographer's address on verso, noting that no authorization is forthcoming from the gallery, and remarking that a wire giving authorization was just received. 2¼ pages, small 8vo, third page written vertically, written on a folded sheet, personal stationery; second page crossed out with two vertical lines, horizontal fold."
